...
export async function multiplyTwoNumbersTemplate(userCode, testCase,currentlang) {
...
int main() {
    int result = mul(${testCase.a}, ${testCase.b});
    printf("%d", result);
    return 0;
}`;
    }
...
int main() {
    cout << mul(${testCase.a}, ${testCase.b});
    return 0;
}
`; 
    }
...
console.log(mul(${testCase.a}, ${testCase.b}));`;
    }
    else
    if(currentlang=="java"){
        fullcode = 
   ...
   ${userCode}
    ...
    public static void main(String[] args) {
        System.out.println(mul(${testCase.a}, ${testCase.b}));
    }
}`;
    }
    else
