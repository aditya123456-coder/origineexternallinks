...
export async function countComponentsingraph(userCode, testCase, currentlang) {
...
int main(){
    ...
    printf("%d", countComponents(V, adj));
    return 0;
}`;
    }
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.print(sol.countComponents(V, adj));
    }
}`;
    }
...
console.log(countComponents(V, adj));
`;
    }
