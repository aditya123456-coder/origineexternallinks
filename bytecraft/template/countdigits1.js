...
export async function countdigits1(userCode, testCase, currentlang) {
...
int main(){
    printf("%d", countDigits(${testCase.num}));
    return 0;
}`;
    }
...
${userCode}
    ...
    public static void main(String[] args){
        System.out.print(countDigits(${testCase.num}));
    }
}`;
    }
...
console.log(countDigits(${testCase.num}));
`;
    }
