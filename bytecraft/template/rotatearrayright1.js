...
export async function rotatearrayright1(userCode, testCase, currentlang) {
...
${userCode}
    ...
    public static void main(String[] args){
        int[] arr = {${testCase.arr.join(",")}};
        int[] res = rotateRight(arr, arr.length, ${testCase.k});
...
const res = rotateRight(arr, arr.length, ${testCase.k});
