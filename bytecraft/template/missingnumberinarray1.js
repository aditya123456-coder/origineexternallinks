...
export async function missingnumberinarray1(userCode, testCase, currentlang) {
...
${userCode}
    ...
    public static void main(String[] args){
        int[] arr = {${testCase.arr.join(",")}};
        System.out.print(findMissing(arr, ${testCase.n}));
    }
}`;
    }
...
console.log(findMissing(arr, ${testCase.n}));
`;
    }
