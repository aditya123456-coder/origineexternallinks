...
export async function armstrong1(userCode, testCase, currentlang) {
...
int main(){
    printf("%d", isarmstrong(${testCase.num}));
    return 0;
}`;
    }
...
${userCode}
    ...
    public static void main(String[] args){
        System.out.print(isarmstrong(${testCase.num}));
    }
}`;
    }
...
console.log(isarmstrong(${testCase.num}));
`;
    }
