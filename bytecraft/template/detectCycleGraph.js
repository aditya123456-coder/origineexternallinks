...
export async function detectCycleGraph(userCode, testCase, currentlang) {
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.print(sol.hasCycle(V, adj));
    }
}`;
    }
