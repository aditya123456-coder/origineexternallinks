...
export async function secondlargestinarray1(userCode, testCase, currentlang) {
...
${userCode}
    ...
    public static void main(String[] args){
        int[] arr = {${testCase.arr.join(",")}};
        System.out.print(secondLargest(arr, arr.length));
    }
}`;
    }
...
console.log(secondLargest(arr, arr.length));
`;
    }
...
secondLargest ${testCase.arr.join(" ")}
`;
    }
