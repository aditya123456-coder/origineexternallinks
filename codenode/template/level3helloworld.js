export function runAndValidate({ dropzone, output, validationResult, levelConfig }) {
  ...
  const expected = levelConfig.expectedStructure; // ['start','print','print']
  let hasError = false;
